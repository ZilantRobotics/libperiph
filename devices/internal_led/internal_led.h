...
typedef enum {
    INTERNAL_LED_STATE_ARMED_NO_FIX,
    INTERNAL_LED_STATE_ARMED_3D_FIX,
    INTERNAL_LED_STATE_DISARMED_NO_FIX,
    INTERNAL_LED_STATE_DISARMED_3D_FIX,
    INTERNAL_LED_STATE_DISARMED_WARNING,
    INTERNAL_LED_STATE_ERROR,
} InternalLedState_t;
